...
export default function ArchitectureForm({ onSubmit, isLoading }: ArchitectureFormProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        onSubmit({ projectName, scale, description });
    };
        ...
        >
            ...
            <motion.div variants={inputVariants}>
                ...
                <div className="relative group">
                    ...
                    <textarea
                        ...
                        placeholder="Describe what the application does. Mention if you need realtime web sockets, heavy data analytics, video processing, or alerting systems..."
                        className="glass-input resize-none relative z-10 bg-slate-900/80 backdrop-blur-sm"
                        disabled={isLoading}
                    />
                </div>
                <p className="text-xs text-slate-500 mt-2 font-mono opacity-80">
                    \/* Our AI scans for keywords like "realtime", "analytics", "alerts" *\/
                </p>
            </motion.div>
            ...
            <motion.div variants={inputVariants} className="pt-2">
                <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    type="submit"
                    disabled={isLoading || !projectName || description.length < 20}
